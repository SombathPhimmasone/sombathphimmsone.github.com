...
void CScoreBoard::Draw()
{
    ...
    ImGui::Begin(szServerAddress, nullptr, fScoreBoardFlags);

    cp1251_to_utf8(ctitle, serverUTF8.c_str());

    ImGui::Columns(2, "Scoreboard Title");
    ImGui::Text(" %s", ctitle); ImGui::SetColumnWidth(-1, m_fScoreBoardSizeX / 100 * 85); ImGui::NextColumn();
    ImGui::Text("Players: %d", m_pPlayerCount); ImGui::SetColumnWidth(-1, m_fScoreBoardSizeX / 100 * 15); ImGui::NextColumn();
    ImGui::Columns(1);

    ImGui::Text("");

    ImGui::Columns(4, "Scoreboard Titles");
    ImGui::Text(" ไอดี"); ImGui::SetColumnWidth(-1, m_fScoreBoardSizeX / 100 * 10); ImGui::NextColumn();
    ImGui::Text(" ชื่อ"); ImGui::SetColumnWidth(-1, m_fScoreBoardSizeX / 100 * 60); ImGui::NextColumn();
    ImGui::Text(" สกอร์"); ImGui::SetColumnWidth(-1, m_fScoreBoardSizeX / 100 * 15); ImGui::NextColumn();
    ImGui::Text(" ปิง"); ImGui::SetColumnWidth(-1, m_fScoreBoardSizeX / 100 * 15); ImGui::NextColumn();
    ImGui::Columns(1);

    ImGui::BeginChild("", ImVec2(-1, -1), true);

    ImGui::Columns(4, "Scoreboard");
    ImGui::SetColumnWidth(-1, m_fScoreBoardSizeX / 100 * 10); ImGui::NextColumn();
    ImGui::SetColumnWidth(-1, m_fScoreBoardSizeX / 100 * 60); ImGui::NextColumn();
    ImGui::SetColumnWidth(-1, m_fScoreBoardSizeX / 100 * 15); ImGui::NextColumn();
    ImGui::SetColumnWidth(-1, m_fScoreBoardSizeX / 100 * 15); ImGui::NextColumn();
